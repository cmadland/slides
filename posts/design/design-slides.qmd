...
date: "2026-05-11"
categories: [design, design thinking, edci337]
image: "bike.jpg"
format:
  revealjs:
    # multiplex: true
    incremental: true
    footer: "Contributors: Colin Madland, Scott Macklin, Mark Halvorson"
    logo: "visualstickery.jpg"
    mermaid-format: png
---
...
## The four stages of backward learning design.

```{mermaid}
flowchart LR
  A([Identify Outcomes]) --> B([Determine Criteria])
  B --> C([Determine Assessment Tasks])
  C --> D([Plan Learning Experiences and Resources])
```
